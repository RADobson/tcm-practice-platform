...
const navItems = [
  ...
  { href: '/dashboard/consultation-recorder', label: 'Audio Recorder', icon: '⊙' },
  ...
  { href: '/dashboard/diagnostics/ai-synthesis', label: 'AI Synthesis', icon: '◇' },
  { href: '/dashboard/diagnostics/herbal-ai', label: 'AI Prescriber', icon: '❋' },
  { href: '/dashboard/diagnostics/treatment-plan', label: 'AI Treatment', icon: '⊹' },
